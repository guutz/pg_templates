...
During the ${c.length} day challenge, we completed [b][color=red]${c.total_tasks_done}[/b][/color] tasks (including doublechecks). >new primes<

Overall, the challenge boosted the project's average output to over [b][u][color=green]10 times[/color][/u][/b] typical at its peak.
